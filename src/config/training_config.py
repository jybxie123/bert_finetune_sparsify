...
class train_config:
    ...
    expr_name: str = (
        f"ass_bert_{dataset_name}_{dataset_length}_{hidden_act}_keep_frac_{keep_frac}_epoch_{num_epochs}_custom_{mode}_{is_sparse_softmax}_st_{is_sparse_layer_norm}_ln_4_13"  # _var_no_sm_no_weight' #_norm_no_sm_no_weight_no_double_matmul_add_mem_profiler' # # _norm_no_sm_no_weight
    )
